...
class PlazajapanSpider(scrapy.Spider):
    name = "plazajapan"
    ...
    def start_requests(self):
        ...
        base = "https://www.plazajapan.com/search.php"
    ...
    def parse_product(self, resp):
        ...
        if price is None:
            ...
            m = re.search(r"([0-9]+(?:\.[0-9]{2})?)\s*(USD|\$)", txt, re.I)
            if m:
                try:
