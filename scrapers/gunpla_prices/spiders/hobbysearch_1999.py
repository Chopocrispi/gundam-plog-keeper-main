...
class Hobbysearch1999Spider(scrapy.Spider):
    name = "hobbysearch1999"
    ...
    def start_requests(self):
        ...
        base = "https://www.1999.co.jp/eng/search"
        params = {"typ1": "Sld", "searchkey": q}
