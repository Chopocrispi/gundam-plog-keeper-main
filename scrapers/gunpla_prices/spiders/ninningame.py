...
class NinningameSpider(scrapy.Spider):
    name = "ninningame"
    ...
    def start_requests(self):
        ...
        base = "https://www.nin-nin-game.com/en/module/pm_advancedsearch/pm_advancedsearch"
    ...
    def parse_product(self, resp):
        ...
        if price is None:
            ...
            m = re.search(r"([0-9]+(?:\.[0-9]{2})?)\s*(EUR|€|USD|\$|JPY|¥)", txt, re.I)
            if m:
                try:
